...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className="left-0 top-0 hidden h-full w-full max-w-64 flex-col justify-between bg-sidebar-background py-4 lg:fixed lg:flex">
        <div className="w-full">
          <Link
            href={"/"}
            className="px-6 pb-6 text-3xl font-bold text-primary"
          >
            Organa
          </Link>
